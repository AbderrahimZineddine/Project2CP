...
router.get('/applications/daily', getDailyDocs2(Application));
router.get('/applications/monthly', getMonthlyDocs2(Application));
router.get('/applications/yearly', getYearlyDocs2(Application));
router.get('/applications/applicationPerJobCategory',applicationPerJobCategory);
router.get('/applications/GeneralDonutChart',applicationGeneralDonutChart);
