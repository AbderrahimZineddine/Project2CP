...
router.get('/me', authController_1.default.protect, dealController_1.default.getMyDeals, dealController_1.default.sortMiddleware, dealController_1.default.getAllDeals);
...
router.patch('/:id/finishAccept', dealController_1.default.checkOwnerDeal, dealController_1.default.finishDealAccept);
router.delete('/:id', dealController_1.default.checkOwnerDeal, dealController_1.default.deleteDealById);
router.get('/', dealController_1.default.sortMiddleware, dealController_1.default.getAllDeals);
