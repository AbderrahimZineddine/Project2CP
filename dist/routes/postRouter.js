...
router.get('/:id', authController_1.default.protect, authController_1.default.restrictTo('Worker'), postController_1.default.getPostById);
router.get('/', authController_1.default.isLoggedIn, postController_1.default.getAllPosts);
