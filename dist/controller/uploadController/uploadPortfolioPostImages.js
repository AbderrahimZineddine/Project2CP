...
const uploadController_1 = __importDefault(
  require('../../controller/uploadController')
);
const uploadImages = (0, catchAsync_1.default)(async (req, res, next) => {
  if (!req.files) {
    // return next(
  ...
  try {
    ...
    return next(
      new appError_1.default('Error uploading images please try again!', 500)
    );
  }
});
